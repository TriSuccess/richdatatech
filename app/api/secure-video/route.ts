...
const corsHeaders = {
  "Access-Control-Allow-Origin": "https://course2-f1bdb.web.app", // Use your actual frontend domain!
...
export async function GET(req: Request) {
  ...
  // ==== ENTER YOUR cPanel FOLDER USERNAME AND PASSWORD HERE ====
  const username = "Razor7"; // <-- CHANGE THIS
  const password = "S1M3o;OY}ixq"; // <-- CHANGE THIS
